...
end1
cat toggle-list.pug >> newFile.pug
mv -f newFile.pug  toggle-list.pug
...
end3
cat toggle-list.scss >> newFile.scss
mv -f newFile.scss toggle-list.scss
cd ${fileName}
