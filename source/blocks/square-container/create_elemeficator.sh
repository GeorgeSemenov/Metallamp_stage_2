...
end1
cat square-container.pug >> newFile.pug
mv -f newFile.pug  square-container.pug
...
end3
cat square-container.scss >> newFile.scss
mv -f newFile.scss square-container.scss
cd ${fileName}
