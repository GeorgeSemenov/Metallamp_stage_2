...
end1
cat toggle-item.pug >> newFile.pug
mv -f newFile.pug  toggle-item.pug
...
end3
cat toggle-item.scss >> newFile.scss
mv -f newFile.scss toggle-item.scss
cd ${fileName}
