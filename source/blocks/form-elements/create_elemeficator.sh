...
end1
cat form-elements.pug >> newFile.pug
mv -f newFile.pug  form-elements.pug
...
end3
cat form-elements.scss >> newFile.scss
mv -f newFile.scss form-elements.scss
cd ${fileName}
