#!/bin/sh
parentName=color-and-type-screen
...
end1
cat color-and-type-screen.pug >> newFile.pug
mv -f newFile.pug  color-and-type-screen.pug
...
end3
cat color-and-type-screen.scss >> newFile.scss
mv -f newFile.scss color-and-type-screen.scss
cd ${fileName}
