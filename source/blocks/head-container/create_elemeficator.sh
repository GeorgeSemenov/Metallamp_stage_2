...
end1
cat head-container.pug >> newFile.pug
mv -f newFile.pug  head-container.pug
...
end3
cat head-container.scss >> newFile.scss
mv -f newFile.scss head-container.scss
cd ${fileName}
